  ...
  return (
    <div style={styleCSS} className={className ? className : styles.body}>
      <div className={styles.wrap}>
        ...
        <InfoLine label={t('profile.language')} value={info?.language || ''} />
        ...
        <InfoLine label={t('profile.address')} value={info?.address || ''} />

        <InfoLine label={t('profile.position')} value={info?.position || ''} />
        <InfoLine label={t('profile.role')} value={info?.role || ''} />
